      ...
      <div class="widget-box">
         <div class="widget-title">
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#tab1">Voucher Information</a></li>
							...
							<form action="#" method="get" class="form-horizontal">
								...
								<div class="control-group">
									<label for="normal" class="control-label">Voucher Date :</label>
										<div class="controls">
											<input type="date" id="mask-date" class="span8 mask text">
										</div>
								</div>
								<div class="control-group">
					...
					<div class="widget-box">
						...
						<!---- Modal Popup End --->
							<tr class="gradeX">
								...
								<td>01-02-2012</td>
								<td>Student</td>
								<td><a href="vouchers/update" title="Edit"><img src="${pageContext.request.contextPath}/assets/img/edit.png" height="20" width="20"/></a>&nbsp;|&nbsp;<a href="" onclick="return confirm('Are you sure to delete Voucher?');" title="Delete"><img src="${pageContext.request.contextPath}/assets/img/delete.png" height="20" width="20"/></a></td>
							</tr>
							<tr>
								<td>2</td>
								<td>54789445</td>
