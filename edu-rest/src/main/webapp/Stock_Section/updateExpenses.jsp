...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>&nbsp;<a href="<%=applicationURL%>/admin/expenses" title="other expenses" class="tip-bottom">Other Expenses</a></div>
  </div>
<!--End-breadcrumbs-->
		...
		<div class="widget-box">
			<div class="widget-title">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#tab1">Update Other Expenses</a></li>
				</ul>
				...
				<div class="widget-content tab-content">
					<div id="tab1" class="tab-pane active">
						...
						<div class="span6">
							<div class="widget-box">
								<div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
									<h5>Update Other expenses-information</h5>
								</div>
								<div class="widget-content nopadding">
									...
									<label for="normal" class="control-label">Category :  </label>
										<div class="controls">
											<select class="span8 mask text" id="selectCategory" name="category"  onchange="showDiv(this)" onchange="return validateExpensesInformation(this);">
								...
								<div class="school-form" id="school_form" style="display:block;">
										...
										<label for="normal" class="control-label">Details:</label>
											<div class="controls">
												<select class="span8 mask text" id="SchoolItemList" name="SchoolItemList" onchange="return validateExpensesInformation(this);">
													...
													<option value="" selected>Electricity Bill</option>
									...
									<div class="control-group">
										<label class="control-label">Actual Cost:</label>
											<div class="controls">
												<input type="number" class="span11" name="actual_cost" id="actual_cost" autocomplete="off" value="500" onkeyup="return validateExpensesInformation(this);"/>
											    <p id="p4"></p>
											</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Approved Cost:</label>
											<div class="controls">
												<input type="number" class="span11" name="approved_cost" id="appoved_cost" autocomplete="off" value="400" onkeyup="return validateExpensesInformation(this);"/>
											    <p id="p5"></p>
											</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Invalid Cost:</label>
											<div class="controls">
												<input type="number" class="span11" name="invalid_cost" id="invalid_cost" autocomplete="off" value="100" onkeyup="return validateExpensesInformation(this);"/>
											    <p id="p6"></p>
											</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Reasons For Invalid Cost:</label>
											<div class="controls">
												<textarea class="span11" name="reasons_invalid_cost" autocomplete="off" onkeyup="return validateExpensesInformation(this);">No reason</textarea>
											    <p id="p7"></p>
											</div>
									</div>
						...
						<!-- end of personal information form details   -->
								...
								<input type="submit" class="btn btn-success" id="experience_info" onClick="validateExpensesInformation(this)">	
							</div>
