				...
				<div style="height: 20%;">
					...
					<nav>
						<ul>
							...
							<li><a href="#intro"><i class="fa fa-users fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Employees</a></li>
		...
		<div id="wrapper" align="center">
			...
			<!-- background-image: url(../assets/css/images/blue2.jpg); moz-background-size: cover;-webkit-background-size: cover;background-size: cover;background-position: top center !important;background-repeat:no-repeat !important;background-attachment: fixed; -->
				...
				<div class="" style=" width: 80%; height:5%;" align="left">
					<h4 style="color: white; font-family: monospace;"> > &nbsp;Employee Details </h4>
				</div>
				...
				<div class="inner" style="border: 1px solid white; width: 60%; height: 80%; margin-top: 20px; ">
					...
					<form method="post" style="margin-top: 50px;">
										<div class="field half first">
											...
											<input type="text" name="empId" id="empId" style="color: white;"/>
										</div>
										<div class="field half">
											<label for="Name">Name</label>
											<input type="text" name="name" id="name" style="color: white;"/>
										</div>
										
										<div class="field half first">
											<label for="BusinessUnit">Business Unit</label>
											<input type="text" name="bu" id="bu" style="color: white;"/>
										</div>
										<div class="field half">
											<label for="password">Password</label>
											<input type="password" name="passowrd" id="password"  style="color: white;"/>
										</div>
