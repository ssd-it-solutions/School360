			...
			<div class="box-body">
				<div class="mailbox-controls" >
				 <div class="widget-box front-widget-box">
									...
									<p><strong style="font-size:18px;" class="org_title">Organization Name:</strong><span class="output_name"></span></br></p>
								
									<p class="ashram_school"><strong style="font-size:18px;" class="org_title">Name of the Ashram School:</strong><span class="output_name"></span></br></p>
									...
									<p class="org_name"><strong style="font-size:18px;" class="org_title">Name of the Organization President:</strong><span class="output_name"></span></br></p>
		
									<p class="org_mobile_no"><strong style="font-size:18px;" class="org_title">Mobile No:</strong><span class="output_name"></span></br></p>
						
									<p class="principle_name"><strong style="font-size:18px;" class="org_title">Primary/Secondary Principle Name:</strong><span class="output_name">	</span></br></p>	
								
									<p class="principle_mob_no"><strong style="font-size:18px;" class="org_title">Mobile No:</strong><span class="output_name"></span> </br></p>	
							...
							<div class="form-actions" style="display:block;">
								...
								<a href="<%=applicationURL%>/admin/primarySchool" type="button" class="btn btn-success">Next</a>
