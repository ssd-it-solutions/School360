...
<!--End-Chart-box--> 
    ...
    <div class="row-fluid" style="display:block;">
      ...
      <div class="widget-box">
         ...
         <%  StaffDTO loggedInUser = (StaffDTO) request.getAttribute("EmployeeDetails");%>
        <form:form id="staff_form" class="form-horizontal" action="/staff/modifyProfile" modelAttribute="staffDTO" method="post"  onSubmit="return validateExperienceInformation(this);" enctype="multipart/form-data">
						...
						<div class="widget-content nopadding">
								...
								<div class="control-group">
									<label class="control-label">Photo :</label>
										<div class="controls">
											<% String photoStringBase64 = new String(loggedInUser.getPhotoField(),"UTF-8");%>
											<input type="file" name="photo" id="photo" path="photoField" value="<%=loggedInUser.getPhotoField() %>" onchange="return validatePersonalInformation(this);"/>
								...
								<div class="control-group">
									<label class="control-label">Category :</label>
										<div class="controls">
											<form:select class="span8 mask text" id="staffCategory" name="staffCategory" path="staffCategory" value="<%=loggedInUser.getStaffCategory() %>" onchange="return validatePersonalInformation(this);">
											  	<form:option value="None" items="<%=loggedInUser.getStaffCategory() %>">  Select Category  </form:option>
											  	<form:option value="School" items="<%=loggedInUser.getStaffCategory() %>"> School  </form:option>
											  	<form:option value="Hostel" items="<%=loggedInUser.getStaffCategory() %>">  Hostel  </form:option>
											</form:select>
											<p id="p2"></p>
										</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label">First Name :</label>
										<div class="controls">
											<form:input type="text" id="firstName" autocomplete="off" name="firstName" value="<%=loggedInUser.getFirstName() %>" path="firstName" onkeyup="return validatePersonalInformation(this);"/>
											<form:input type="hidden" id="id" name="id" value="<%=loggedInUser.getId() %>" path="id"  />
											<p id="p3"></p>
										</div>
								</div>
								<div class="control-group">
									<label class="control-label">Middle Name :</label>
										<div class="controls">
											<form:input type="text" class="span11" name="middleName" id="middleName" value="<%=loggedInUser.getMiddleName() %>" path="middleName" onkeyup="return validatePersonalInformation(this);"/>
											<p id="p4"></p>
										</div>
								</div>
								<div class="control-group">
									<label class="control-label">Last Name :</label>
										<div class="controls">
											<form:input type="text" class="span11" name="lastName" autocomplete="off" id="lastName" value="<%=loggedInUser.getLastName() %>" path="lastName" onkeyup="return validatePersonalInformation(this);"/>
											<p id="p5"></p>
										</div>
								</div>
								<div class="control-group">
								<label class="control-label">Address : </label>
									<div class="controls">
										<form:textarea class="span11" name="address" id="address" autocomplete="off" path="address" value="<%=loggedInUser.getAddress() %>" onkeyup="return validatePersonalInformation(this);"/>
										<p id="p6"></p>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Age :</label>
										<div class="controls">
											<form:input type="number" class="span11" name="age" id="age" value="<%=loggedInUser.getAge() %>" path="age" />
										</div>
								</div>
								<div class="control-group">
									<label class="control-label">Email :  </label>
										<div class="controls">
											<form:input type="email" class="span11" name="emailAddress" id="emailAddress" autocomplete="off" path="emailAddress" value="<%=loggedInUser.getEmailAddress() %>" onkeyup="return validatePersonalInformation(this);"/>
										    <p id="p7"></p>
										</div>
								</div>
								<div class="control-group">
									<label class="control-label">Mobile Number :  </label>
										<div class="controls">
											<form:input type="number" class="span11" name="phoneNumber" id="phoneNumber" autocomplete="off" path="phoneNumber" value="<%=loggedInUser.getPhoneNumber() %>" onkeyup="return validatePersonalInformation(this);"/>
										    <p id="p8"></p>
										</div>
								</div>
								<div class="control-group">
									<label class="control-label">Gender :  </label>
										<div class="controls">
											...
											<form:radiobutton   class="" name="gender" id="gender" path="gender" value="Male" checked="<%= loggedInUser.getGender().equalsIgnoreCase(\"Male\")?true:false  %>" onchange="return validatePersonalInformation(this);"/> Male &nbsp;&nbsp;
											<form:radiobutton   class="" name="gender" id="gender" path="gender" value="Female" checked="<%= loggedInUser.getGender().equalsIgnoreCase(\"Female\")?true:false  %>" onchange="return validatePersonalInformation(this);"/> Female 
										    <p id="p9"></p>
										</div>
								</div>
								<div class="control-group">
									<label for="normal" class="control-label">DOB :</label>
										<div class="controls">
											<form:input type="date" id="dob" class="span8 mask text" name="date" value="<%=loggedInUser.getDob() %>" path="dob" onchange="return validatePersonalInformation(this);"/>
											<p id="p10"></p>
										</div>
								</div>
								<div class="control-group">
									<label for="normal" class="control-label">Aadhar Number :</label>
										<div class="controls">
											<form:input type="number" class="span11" name="adharNo" id="adharNo" autocomplete="off" data-type="adhaar-number" maxLength="14" value="<%=loggedInUser.getAdharNo() %>" path="adharNo" onkeyup="return validatePersonalInformation(this);"/>
										    <p id="p11"></p>
										</div>
								</div>
								<div class="control-group">
						...
						<div class="widget-content nopadding">
								...
								<div class="control-group">
									<label for="normal" class="control-label">Joining Date</label>
										<div class="controls">
											<form:input type="date" id="joining_date" class="span8 mask text" value="<%=loggedInUser.getJoiningDate() %>" path="joiningDate" onchange="return validatePersonalInformation(this);"/>
											<p id="p13"></p>
										</div>
								</div>
								<div class="control-group">
									<label for="normal" class="control-label">Assign Class</label>
										<div class="controls">
											<form:select class="span8 mask text chosen-select" id="cls" data-placeholder="select some classes" value="<%=loggedInUser.getAssignClass() %>" path="assignClass" onchange="return validatePersonalInformation(this);">
								...
								<div class="control-group">
									<label for="normal" class="control-label">Assign Division</label>
										<div class="controls">
											<form:select class="span8 mask text chosen-select" id="div" data-placeholder="select some divisions" value="<%=loggedInUser.getAssignDivision() %>" path="assignDivision" onchange="return validatePersonalInformation(this);">
								...
								<div class="control-group">
									<label class="control-label">Joining Type :  </label>
										<div class="controls">
											<form:radiobutton   class=""  name="joiningPeriod" id="joiningPeriod" path="joiningPeriod" value="Temporary" checked="<%= loggedInUser.getJoiningPeriod() %>" onchange="return validatePersonalInformation(this);"/> Temporary &nbsp;&nbsp;
											<form:radiobutton   class=""  name="joiningPeriod" id="joiningPeriod" path="joiningPeriod" value="Permanent" checked="<%= loggedInUser.getJoiningPeriod() %>" onchange="return validatePersonalInformation(this);"/> Permanent 
										    <p id="p16"></p>
										</div>
								</div>
					...
					<div class="widget-content nopadding">
							...
							<div class="control-group">
								<label class="control-label">Qualification :</label>
									<div class="controls">
										<form:select class="span8 mask text" name="qualification" id="qualification" value="<%=loggedInUser.getQualification() %>" onchange="return validateEducationalInformation(this);" path="qualification">
							...
							<div class="control-group">
								<label class="control-label">Institute :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="institute" id="institute" autocomplete="off" value="<%=loggedInUser.getInstitute() %>"  path="institute" onchange="return validateEducationalInformation(this);"/>
										<p id="p18"></p>
									</div>
							</div>
							<div class="control-group">
								<label class="control-label">Board :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="board" id="board" autocomplete="off" value="<%=loggedInUser.getBoard() %>" path="board" onchange="return validateEducationalInformation(this);"/>
										<p id="p19"></p>
									</div>
							</div>
							<div class="control-group">
								<label class="control-label">Marks/Grade :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="marks" id="marks" autocomplete="off" value="<%=loggedInUser.getMarks() %>"  path="marks" onchange="return validateEducationalInformation(this);"/>
										<p id="p20"></p>
									</div>
							</div>
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
								...
								<label class="control-label">Period :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="totalWorkExperience" autocomplete="off" id="totalWorkExperience" value="<%=loggedInUser.getTotalWorkExperience() %>" path="totalWorkExperience" onkeyup="return validateExperienceInformation(this);"/>
									    <p id="p21"></p>
									</div>
								</div>
								...
								<label class="control-label">Organization & Address :</label>
									<div class="controls">
										<form:textarea class="span11" name="organizationAddress" id="organizationAddress" autocomplete="off" path="organizationAddress" value="<%=loggedInUser.getOrganizationAddress() %>" onkeyup="return validateExperienceInformation(this);"/>
									    <p id="p22"></p>
									</div>
								</div>
								...
								<label class="control-label">Designation :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="designation" id="designation" autocomplete="off" value="<%=loggedInUser.getDesignation() %>"  path="designation" onkeyup="return validateExperienceInformation(this);"/>
									    <p id="p23"></p>
									</div>
								</div>
								...
								<label class="control-label">Personal Achievements(if any) :</label>
									<div class="controls">
										<form:input type="text" class="span11" id="achievements" name="achievements" autocomplete="off" value="<%=loggedInUser.getAchievements() %>" path="achievements" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p24"></p>
									</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label">Aadhar Card :</label>
										<div class="controls">
											<input type="file" name="adhar_card" id="adhar_card"  value="<%=loggedInUser.getAdharCardField() %>" accept=".png, .jpg, .jpeg, .pdf" onchange="return validateExperienceInformation(this);"/>
											<p id="p25"></p>
										</div>
								</div>
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
								...
								<label class="control-label">Month : </label>
									<div class="controls">
										<form:select class="span8 mask text" id="salary_month" name="salaryMonth" path="salaryMonth" value="<%=loggedInUser.getSalaryMonth() %>" onchange="return validateExperienceInformation(this);">
								...
								<label class="control-label">Basic Salary : </label>
									<div class="controls">
										<form:input type="text" class="span11" name="basicSalary" autocomplete="off" id="basicSalary" value="<%=loggedInUser.getBasicSalary() %>" path="basicSalary" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p27"></p>
									</div>
								</div>
								...
								<label class="control-label">Dearness allowance : </label>
									<div class="controls">
										<form:input type="text" class="span11" name="dearnessAllowance" autocomplete="off" id="dearnessAllowance" value="<%=loggedInUser.getDearnessAllowance() %>" path="dearnessAllowance" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p28"></p>
									</div> 
								</div>
							   ...
							   <div class="control-group">
								<label class="control-label">House rent allowance :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="houseAllowance" autocomplete="off" id="houseAllowance" value="<%=loggedInUser.getHouseAllowance() %>" path="houseAllowance" onkeyup="return validateExperienceInformation(this);" />
										<p id="p29"></p>
									</div>
								</div>
								...
								<label class="control-label">Incentive allowance/Others :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="incentiveAllowance" autocomplete="off" id="incentiveAllowance" value="<%=loggedInUser.getIncentiveAllowance() %>" path="incentiveAllowance" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p30"></p>
									</div>
								</div>	
								...
								<label class="control-label">Total Salary :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="totalSalary" autocomplete="off" id="totalSalary" value="<%=loggedInUser.getTotalSalary() %>" path="totalSalary" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p31"></p>
									</div>
								</div>			
								...
								<label class="control-label">Cut :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="cutSalary" id="cutSalary" autocomplete="off" value="<%=loggedInUser.getCutSalary() %>" path="cutSalary" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p32"></p>
									</div>
								</div>	
								...
								<label class="control-label">Net payable :</label>
									<div class="controls">
										<form:input type="text" class="span11" name="netPayable" autocomplete="off" id="netPayable" value="<%=loggedInUser.getNetPayable() %>" path="netPayable" onkeyup="return validateExperienceInformation(this);"/>
										<p id="p33"></p>
									</div>
								</div>	
								<div class="form-actions" style="display:block;">
