...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="quick-actions_homepage">
       	...
       	<h1 class="form-name">Statement - 22</h1>
		<h4 class="form-name">Name of aided Ashram School:</h4>
		<h4 class="form-name"> Showing outstanding balance details Year <script>document.write(new Date().getFullYear()- 2);</script>-<script>document.write(new Date().getFullYear()- 1);</script></h4>
						...
						<table class="table table-bordered data-table with-check" id="my-table">
						 ...
						 <td></td>
							...
							<tr>
						 	...
						 	<tr>
								<td>&nbsp;</td>
								<td class="total_weight" >B) Total Cost Rs.</td>
								<td style="border-left:0px solid #ddd; width:75px;">&nbsp;</td>
									<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
