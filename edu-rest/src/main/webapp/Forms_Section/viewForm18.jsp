...
<div id="content">
	...
	<div class="container-fluid">
		...
		<p class="form-type"> Showing details of actual contingency expenses incurred in <script>document.write(new Date().getFullYear()- 1);</script>-<script>document.write(new Date().getFullYear()- 0);</script>(as per the Chartered Report)</p>
