...
<div id="content">
	...
	<div class="container-fluid">
		<h1 class="form-name">Statement - 17</h1>
		<p class="form-type">Details of Inadequate Pay Scale (as per the Fifth Pay Commission) Payments payable</p>
		<p class="form-type">(Hostel Department)</p>
		<h1 class="form-role ">Year :- <script>document.write(new Date().getFullYear()- 2);</script>-<script>document.write(new Date().getFullYear()- 1);</script></h1>
		<hr>
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered data-table with-check" id="my-table">
							...
							<tr>
								...
								<th>Total 1 Month Salary(5+6+7+8)</th>
								<th>Total Amount(4 * 9)</th>
