		...
		<div class="widget-box">
			<div class="widget-title">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#tab1">Add Hostel List</a></li>
				</ul>
			</div> <!-- End of widget-title --->
			<form name="hostel_form" class="form-horizontal" id="hostel_form">
						...
						<div class="span6">
							<div class="widget-box">
								<div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
									<h5>Add Hostel List-information</h5>
								</div>
								<div class="widget-content nopadding">
									
								<div class="hostel_form" id="hostel_form" style="display:block;">
